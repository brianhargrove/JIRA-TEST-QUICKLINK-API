...
var spec = require('./config/boostrap-spec');
var config = new Configurator();

require('./app_default_env');

var authKeyFile = path.normalize(process.env.BOOTSTRAP_JWT_ISSUER_PUB);
var authenticPublicKey = fs.readFileSync(authKeyFile, 'utf8');

var privKeyFile = path.normalize(process.env.BOOTSTRAP_TRUSTED_ENDPOINT_KEYFILE);
